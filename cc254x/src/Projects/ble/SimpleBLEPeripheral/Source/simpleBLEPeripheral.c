...
#define DEFAULT_DEVICE_NAME  "AmoRgbLight"
...
0表示不上报， 单位 ms, 默认值  TEMP_DEFAULT_UPDATE_TIME_S
*/
#define TEMP_DEFAULT_UPDATE_TIME_MS   1000


// 最高温度报警
#define DEFAULT_TEMP_HIGHT_ALERT      3012   // 高八位是温度整数，低八位是温度小数
// 最低温度报警
#define DEFAULT_TEMP_LOW_ALERT      2055   // 高八位是温度整数，低八位是温度小数
...
uint8 g_initFlag = FALSE;        // 初始化标志，烧录后第一次启动用于启动测试用
